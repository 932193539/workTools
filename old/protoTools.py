...
import os
#proto文件
openFile = r"D:\svn\workspace\branch_trunk_function_20180903_0914\Common\platform_jar\proto\club.proto"
#需要获取的proto协议
gainProto = ["CCLInvitePlayerREQ","CLCInvitePlayerSYN","CCLRefuseOrAcceptInviteREQ","CLCRefuseOrAcceptInviteRES","CLCInvitePlayerRES"]
#使用该协议的service
serviceName = "ClubMemberService"
