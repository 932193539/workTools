...
def readSVNLog():
    ...
    rootDir = "svn://172.16.1.201:3692/mahjong/src_quanguo/branches/branch_cangzhou_gameplay_20180827_0831"  ## svn路径

    startDate = "{2018-08-29T10:35:06}"  ## 开始时间
    endDate = "{2018-08-29T22:35:06}"    ## 终止时间
    xlsx = r"D:\workTools\Book1.xlsx"  ## 保存的excel路径以及文件名
