...
#UI路径和控件名称
uiDir = r'D:\svn\workspace\branch_trunk_dev_multiarea\Skins\quanguobao_guiyang\cocosstudio\csb\UISetting.csd'
gainNodeList = ["CheckBox_JinZhong","CheckBox_XuChang","CheckBox_Quanguo","CheckBox_Wait","CheckBox_5_Setting"]#,,"Image_18""changeText","changeText","changeText","changeText","changeText"]
