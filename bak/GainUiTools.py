...
#UI路径和控件名称
uiDir = r'D:\svn\workspace\branch_jinzhong\Skins\quanguobao_guiyang\cocosstudio\csb\Club\UIClubRealTimeInfo.csd'
gainNodeList = ["Button_Close","Panel_player1","Image_face_player1","Text_Score_Count3","ListView_Item","Panel_Item","Text_Score2","","","","",""]#,,"Image_18""changeText","changeText","changeText","changeText","changeText"]
