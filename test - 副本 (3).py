...
LIST_FILE = [ '\Client\src\__ClickButton.lua', '\Client\src\__DispatchEvent.lua' , '\Client\src\__Message.lua', '\Client\src\__OpenUI.lua']
...
class Tools(Frame):
	...
	def openfile(self,fileID):
		...
		fo = open(r'' + self.lb.get(index) + LIST_FILE[fileID], "r")
