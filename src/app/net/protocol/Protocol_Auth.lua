...
function CIAccountAuthREQ:setData(channel, username, code, refreshToken,area, subChannel, updateChannel)
	...
	protocolBuf.proVersion = "200000" --tostring(game.service.UpdateService.getInstance():getProductVersion():getVersions()[1]);
	protocolBuf.libVersion = "200000"--game.plugin.Runtime.getBuildVersion()
