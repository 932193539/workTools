...
#UI路径和控件名称
uiDir = r'D:\svn\tag\branch_master_gameplay_YangQuan\Skins\quanguobao_jinzhong\cocosstudio\csb\Club\UIClubExamine.csd'
gainNodeList = ["Image_Icon","Text_Name","Text_ID","Button_Confirm","Button_Refuse","ListView_Info","Panel_Info_1","Panel_Content","Text_Info","Panel_Info_2","ListView_Province","Panel_Province","CheckBox_Province","BitmapFontLabel_Province","Button_ok"]#,,"Image_18""changeText","changeText","changeText","changeText","changeText"]
